#!/usr/bin/env pwsh
# Register house system fields with CMS via discover endpoint
...
# Register house system fields via discover endpoint
Write-Host "`n=== Registering House System fields ===" -ForegroundColor Cyan
